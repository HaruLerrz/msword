...
#ifdef OPUS_X64
/* The CS compiler's ragged counted-string array is represented explicitly
 * for a flat C data segment. Text and ordering are the original table. */
struct OPUS_STD_STYLE_NAME
	{
	unsigned char cch;
	char rgch[21];
	};
#define OpusStdStyle(text) { (unsigned char)(sizeof(text) - 1), text }
csconst struct OPUS_STD_STYLE_NAME rgstStd[] =
	{
	OpusStdStyle("Normal"),
	OpusStdStyle("Normal Indent"),
	OpusStdStyle("heading 1"),
	OpusStdStyle("heading 2"),
	OpusStdStyle("heading 3"),
	OpusStdStyle("heading 4"),
	OpusStdStyle("heading 5"),
	OpusStdStyle("heading 6"),
	OpusStdStyle("heading 7"),
	OpusStdStyle("heading 8"),
	OpusStdStyle("heading 9"),
	OpusStdStyle("footnote text"),
	OpusStdStyle("footnote reference"),
	OpusStdStyle("header"),
	OpusStdStyle("footer"),
	OpusStdStyle("index heading"),
	OpusStdStyle("line number"),
	OpusStdStyle("index 1"),
	OpusStdStyle("index 2"),
	OpusStdStyle("index 3"),
	OpusStdStyle("index 4"),
	OpusStdStyle("index 5"),
	OpusStdStyle("index 6"),
	OpusStdStyle("index 7"),
	OpusStdStyle("toc 1"),
	OpusStdStyle("toc 2"),
	OpusStdStyle("toc 3"),
	OpusStdStyle("toc 4"),
	...
	OpusStdStyle("toc 7"),
	OpusStdStyle("toc 8"),
	OpusStdStyle("annotation text"),
	OpusStdStyle("annotation reference")
	};
#undef OpusStdStyle
#else
...
{
#ifdef OPUS_X64
	char far *qst = (char far *)&rgstStd[ist];
#else
