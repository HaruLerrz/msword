...
extern PVS		vpvs;
#ifdef OPUS_X64
extern HANDLE HLoadRes0();
extern HANDLE HFromIbmds0();
extern CHAR **HReadCbFromPrstream();
extern int OpusValidateSttb();
#endif
#ifdef WIN23
extern HFONT		hfontStatLine;
extern int			vdxpDigit;
#ifdef OPUS_X64
extern LRESULT CALLBACK IconDlgWndProc(HWND, UINT, WPARAM, LPARAM);
extern WNDPROC lpfnIconDlgWndProc;
#else
...
/* Clipboard formats */
#ifdef OPUS_X64
csconst CHAR szClipRTF[] = "Rich Text Format";
csconst CHAR szClipLink[] = "Link";
csconst CHAR szClipPrPic[] = "Printer_Picture";
#else
...
extern LONG FAR PASCAL NatStaticEditWndProc();
...
csconst struct WC rgwc [] =
	...
	{ 0,                                                  /* Static Edit */
	CBWESTATICEDIT, idColorNil, szClsStaticEdit, (FARPROC)NatStaticEditWndProc },
